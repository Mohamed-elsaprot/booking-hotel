...
class FormBottomBody extends StatelessWidget {
  const FormBottomBody({Key? key, required this.bookingDataMap, required this.formKey}) : super(key: key);
              ...
              child: BlocConsumer<BookingDataCubit,BookingDataStates>(
                  ...
                  builder: (context,state) {
                    if(state is SubmitLoading){
                      ...
                      return Row(
                        children: [
                          Text('Order sent  ',style: TextStyle(fontWeight: FontWeight.w500,fontSize: size.width*.04),),
                      ...
                      return MaterialButton(
                        onPressed: () async{
                          var cubit= BlocProvider.of<PaymentCubit>(context);
                           await cubit.getOrderId(firstName: 'mohamed', lastName: 'yasser', phone: '01001231231', price: '1000',email: BlocProvider.of<AuthCubit>(context).account!);
